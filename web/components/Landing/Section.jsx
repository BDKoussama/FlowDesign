    ...
    return (
        <div className={`w-full md:h-screen my-40 flex flex-col p-2 md:p-0 ${direction} justify-between items-center`} ref = {setRefs}>
            <div className='flex-1'>    
                <span className="block overflow-hidden uppercase text-[#644595] font-medium mb-5 text-sm md:text-md">
                ...
                <p className="text-lg description font-regular mb-10 w-10/12 will-change-transform translate-y-3/4 opacity-0">
                    {description}
                </p>    
